<template>
    <div class="flex flex-col mt-4 w-full min-h-full animate-fadeIn ">
      ...
      <div>
        <UFormDataTable
          title="Daftar Sub Kategori Pelayanan"
              ...
              >
                <template v-slot:body>
                  ...
                  >
                    ...
                    <td class="px-4 py-2 border border-gray-200">{{ item.service_category_master }}</td>
        ...
        <div class="lg:w-full h-[48px] bg-cyan-700 rounded-t-md ">
          <div class="flex justify-between items-center h-full w-full px-5">
            <div class="text-white">
              Formulir Sub Kategori Pelayanan
            </div>
      ...
      <UFormDialog
        title="Formulir Sub Kategori Pelayanan"
        @onSave="postRecord"
        @onUpdate="postUpdate"
      >
        <template v-slot:formdata>
          <div class="flex flex-col">
            ...
            <div class="mb-4">
              ...
              >Kategori Pelayanan</label>
              <u-combo-box
              v-model="record.service_category_master_id"
              :items="serviceCategoryMaster"
  ...
  export default {
    ...
    setup() {
      ...
      const serviceCategoryMaster = ref([]);
      ...
      const getServiceCategoryMaster = async () => {
        const endpoint = "api/v1/combo/service-category-master";
        const result = await store.getCombo(endpoint, true);
        serviceCategoryMaster.value =result;
      };

  
      onMounted(() => {
        store.setPage({
          title: "Master Sub Kategory",
          subtitle: "Berikut Daftar Sub Kategory Yang Tersedia Aplikasi ",
          breadcrumbs: [
            {
              name: "",
              title: "Master Data",
          ...
          dataUrl: "api/v1/master-data/service-sub-category-master",
          actions: {
            refresh: true,
            add: true,
            edit: true,
