...
export default {
  ...
  setup() {
    ...
    const endpoint = "api/v1/master-data/villages";
    const comboDistrictsUrl = "api/v1/combo/districts";
    const keyWord = ref("");
    const districtOptions = ref([]);

    const headers = [
      { title: "#", key: "ids", align: "center", width: "60px" },
      { title: "Kode", key: "code", align: "center", width: "90px" },
      { title: "Desa / Kelurahan", key: "name", align: "start" },
      {
        title: "Kecamatan",
        key: "district_name",
        align: "start",
    ...
    const fetchDistricts = async () => {
      try {
        const result = await store.getCombo(comboDistrictsUrl, true);
    ...
    onMounted(() => {
      store.setPage({
        ...
        subtitle: "Daftar desa dan kelurahan pada aplikasi",
        breadcrumbs: [
