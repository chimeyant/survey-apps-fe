<template>
          ...
          >
            <template v-slot:body>
              ...
              >
                ...
                <td class="px-4 py-2 border border-gray-300 text-start">{{ item.description }}</td>
  ...
  export default {
    ...
    setup() {
      ...
      const endpoint = "api/v1/survey/survey-topic-categories/"+ route.params.survey_topic_id;
  
      const winheight = window.innerHeight - 320;
      const headers = [
        { title: "#", key: "ids", align: "center", width: "45px" },
        { title: "Kategori", key: "name", align: "start", width: "300px" },
        { title: "Keterangan", key: "name", align: "start",width: "300px" },
      ...
      onMounted(() => {
        store.setPage({
          title: "Manjemen Kategori",
          subtitle: "Berikut Daftar Seluruh Kategori Pada Aplikasi ",
          breadcrumbs: [
            {
              name: "",
              title: "Survey",
